...
async fn main(spawner: Spawner) {
    ...
    let input_task_pins = HardwarePins::<'static> {
        ...
        eng_master_0: Button::new(Input::new(p.PIN_6, Pull::Up)),
        eng_master_1: Button::new(Input::new(p.PIN_7, Pull::Up)),
        eng_reverse_0: Button::new(Input::new(p.PIN_8, Pull::Up)),
        eng_reverse_1: Button::new(Input::new(p.PIN_9, Pull::Up)),
